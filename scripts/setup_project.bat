...
echo ===================================================
echo   ConstruTrans - Script para Inicializar requeriminetos
...
echo [2/5] Configurando el entorno (.env)...
...
echo [3/5] Creando el entorno virtual (venv)...
...
:INSTALL_DEPS
echo [4/5] Instalando dependencias (esto puede tardar pocos minutos)...
