...
class RegistroForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'documento': forms.TextInput(attrs={'class': 'input-custom', 'placeholder': '12345678'}),
            'telefono': forms.TextInput(attrs={'class': 'input-custom', 'placeholder': '3001234567'}),
        }
...
class ProveedorForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'nit': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '900.000.000-0'}),
