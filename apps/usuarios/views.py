...
def mis_entregas(request):
    ...
    return render(request, "usuarios/mis-entregas.html", {"entregas": entregas})
...
def crear_usuario(request):
    ...
    if request.method == "POST":
        ...
        if not all([nombres, apellidos, email, password, telefono, rol, tipo_doc, documento]):
            ...
            return render(
                request, "usuarios/form.html", {"form_data": request.POST, "action": "crear"}
            )
        ...
        try:
            ...
            return render(
                request,
                "usuarios/form.html",
                {"error": error_msg, "form_data": request.POST, "action": "crear"},
            )
...
def editar_usuario(request, id):
    ...
    if request.method == "POST":
        ...
        if not all([nombres, apellidos, telefono]):
            ...
            return render(
                request,
                "usuarios/form.html",
                {"usuario": usuario, "form_data": request.POST, "action": "editar"},
            )
    ...
    return render(
        request, "usuarios/form.html", {"usuario": usuario, "form_data": {}, "action": "editar"}
    )
...
def lista_conductores(request):
    conductores = Usuario.objects.filter(rol="conductor")
    return render(request, "usuarios/conductores_lista.html", {"conductores": conductores})
...
def perfil_conductor(request):
    ...
    return render(
        request,
        "usuarios/perfil-conductor.html",
        {"conductor": conductor, "pedidos": pedidos, "vehiculo": vehiculo},
    )
