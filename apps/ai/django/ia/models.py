...
class ConversationHistory(models.Model):
    ...
    context_metadata = models.JSONField(default=dict, blank=True, help_text="Metadatos del contexto de la conversación")
...
class ConversationMessage(models.Model):
    ...
    prompt_used = models.TextField(blank=True, null=True, help_text="Prompt usado para generar esta respuesta")
    model_used = models.CharField(max_length=100, blank=True, null=True, help_text="Modelo de IA usado")
    response_time = models.FloatField(blank=True, null=True, help_text="Tiempo de respuesta en segundos")
