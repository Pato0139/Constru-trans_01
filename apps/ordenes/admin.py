...
class OrdenAdmin(admin.ModelAdmin):
    ...
    search_fields = ('cliente__usuario__nombres', 'cliente__usuario__apellidos', 'direccion_destino')
    inlines = [DetalleOrdenInline]
    list_per_page = 20
    
    def cliente_nombre(self, obj):
        return f"{obj.cliente.usuario.nombres} {obj.cliente.usuario.apellidos}"
