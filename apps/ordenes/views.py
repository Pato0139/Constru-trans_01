...
def agregar_materiales(request, id):
    ...
    return render(
        request,
        "ordenes/agregar_materiales.html",
        {"orden": orden, "materiales": materiales, "detalles": detalles},
    )
...
def ver_pedido_admin(request, id):
    ...
    return render(
        request, "ordenes/detalle.html", {"orden": orden, "metodos_pago": MetodoPago.objects.all()}
    )
