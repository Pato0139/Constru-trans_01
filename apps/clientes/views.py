...
from apps.usuarios.models import Catalogo, Stock, UnidadMedida, Usuario
...
def seguimiento_pedidos(request):
    ...
    return render(request, "clientes/seguimiento.html", {"pedidos": pedidos})
...
def historial_pedidos(request):
    ...
    return render(request, "clientes/historial.html", {"pedidos": pedidos})
