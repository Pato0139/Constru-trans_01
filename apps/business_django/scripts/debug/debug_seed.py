...
from apps.inventario.models import MaterialConstruccion, Stock
...
try:
    ...
    u_cl, _ = User.objects.get_or_create(username='test_client', defaults={'email': 'test@test.com'})
