...
urlpatterns = [
    ...
    path(
        "conductores/asignar-vehiculo/<int:conductor_id>/",
        views.asignar_vehiculo_conductor,
    ...
    path(
        "notificaciones/marcar-leida/<int:id>/",
    ...
    path(
        "recuperar/enviado/",
        auth_views.PasswordResetDoneView.as_view(template_name="usuarios/password_enviado.html"),
